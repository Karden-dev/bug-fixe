  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // SyncService (Dépend de Dio, via AuthService ET _notificationService)
        ProxyProvider<AuthService, SyncService>( // CORRIGÉ : Type non-nullable
          update: (context, auth, previousSyncService) {
            final dio = auth.dio;
            // CORRECTION: Passer _notificationService au constructeur
        ...
        ProxyProvider2<AuthService, SyncService, OrderService?>( // CORRIGÉ : Type SyncService non-nullable
