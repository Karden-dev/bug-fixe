  ...
  Future<List<Order>> _fetchOrders() async {
    ...
    if (orderService == null) {
      ...
      final orderServiceRetry = Provider.of<OrderService?>(context, listen: false);
       ...
       // **CORRECTION ICI**: Utiliser ['all'] pour les statuts
       return orderServiceRetry.fetchRiderOrders(
          statuses: ['all'], // <- MODIFIÉ ICI
      ...
      body: RefreshIndicator(
        ...
        child: FutureBuilder<List<Order>>(
          ...
          builder: (context, snapshot) {
            ...
            // Tri: prêt non récupéré > urgent > date ancienne (maintenu même si tous les statuts sont affichés)
...
// (Le widget OrderCard reste inchangé par rapport à la version précédente)
