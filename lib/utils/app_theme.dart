...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      ...
      // CORRECTION: Utiliser surface au lieu de background
      surface: background,
      error: danger,
      background: background, // Garder background ici pour ThemeData.scaffoldBackgroundColor si nécessaire, mais surface pour le scheme
    ),
