...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const fetchData = async () => {
        try {
            ...
            debtsTableBody.innerHTML = `<tr><td colspan="8" class="text-center p-4"><div class="spinner-border text-primary-custom" role="status"><span class="visually-hidden">Chargement...</span></div></td></tr>`;
                ...
                <td class="text-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ${isPending ? `<li><a class="dropdown-item settle-btn" href="#" data-id="${debt.id}"><i class="bi bi-check-circle"></i> Régler</a></li>` : ''}
                            <li><a class="dropdown-item edit-btn ${!isManual || !isPending ? 'disabled' : ''}" href="#" data-id="${debt.id}"><i class="bi bi-pencil"></i> Modifier</a></li>
                            <li><a class="dropdown-item delete-btn text-danger ${!isManual || !isPending ? 'disabled' : ''}" href="#" data-id="${debt.id}"><i class="bi bi-trash"></i> Supprimer</a></li>
                        </ul>
                    </div>
                </td>
            `;
