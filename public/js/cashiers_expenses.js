...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const API_BASE_URL = 'http://localhost:3000';
    ...
    const expenseUserSelect = document.getElementById('expenseUserSelect'); // Mise à jour du nom de la variable
    const expenseCategorySelect = document.getElementById('expenseCategorySelect'); // Référence à la liste des catégories
