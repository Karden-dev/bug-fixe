...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderPage = () => {
        ...
        if (filteredRemittances.length === 0) {
            remittanceTableBody.innerHTML = `<tr><td colspan="8" class="text-center p-3">Aucun versement à afficher pour les filtres sélectionnés.</td></tr>`;
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item edit-payment-btn" href="#" data-shop-id="${rem.shop_id}">Modifier Infos Paiement</a></li>
    ...
    remittanceTableBody.addEventListener('click', async (e) => {
        ...
        // ... Logique pour les autres boutons (Détails, Modifier)
    });
