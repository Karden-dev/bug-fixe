...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const renderPaginatedTable = () => {
    ...
    ordersToRender.forEach((order) => {
      ...
      const disableStatusBtn = !canChangeStatus;
        ...
        <td>
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item status-delivered-btn ${disableStatusBtn ? 'disabled text-muted' : ''}" href="#" data-order-id="${order.id}"><i class="bi bi-check-circle me-2"></i> Livrée</a></li>
                    <li><a class="dropdown-item status-failed-btn ${disableStatusBtn ? 'disabled text-muted' : ''}" href="#" data-order-id="${order.id}"><i class="bi bi-x-circle me-2"></i> Livraison ratée</a></li>
                    <li><a class="dropdown-item status-reported-btn ${disableStatusBtn ? 'disabled text-muted' : ''}" href="#" data-order-id="${order.id}"><i class="bi bi-clock me-2"></i> À relancer</a></li>
                    <li><a class="dropdown-item status-cancelled-btn ${disableStatusBtn ? 'disabled text-muted' : ''}" href="#" data-order-id="${order.id}"><i class="bi bi-slash-circle me-2"></i> Annulée</a></li>
                    <li><hr class="dropdown-divider"></li>
