// public/sw.js
// Version 2.2 - Corrigée et Robuste pour une gestion hors ligne complète (Version Mise à Jour)

// Import du script helper pour la base de données locale (IndexedDB)
importScripts('https://cdn.jsdelivr.net/npm/idb@7/build/umd.js');

const STATIC_CACHE_NAME = 'wink-express-static-v6'; // Cache pour les fichiers de l'application (HTML, CSS, JS)
