...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const updateGlobalTotals = (reports) => {
        let totalRemit = 0, totalDebt = 0, totalPackaging = 0, totalStorage = 0, totalExpedition = 0, activeMerchantsCount = 0;
        reports.forEach(report => {
            ...
            totalExpedition += parseFloat(report.total_expedition_fees);
        ...
        if (button) {
            ...
            try {
                ...
                if (parseFloat(reportDetails.total_storage_fees) !== 0) {
                    reportContent += `*Total Frais de stockage :* ${formatAmount(reportDetails.total_storage_fees)}\n`;
                }
