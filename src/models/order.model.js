...
module.exports = {
     ...
     * CORRECTION: La modification est autorisée même si le colis a été récupéré.
     */
    update: async (orderId, orderData, userId) => {
        ...
        try {
            ...
            // --- CORRECTION: Vérification de sécurité (picked_up_by_rider_at) SUPPRIMÉE ---
    ...
    findOrdersToPrepare: async () => {
        ...
        try {
            ...
            // *** CORRECTION ICI : Remplacement de // par -- pour le commentaire SQL ***
            let query = `
                SELECT
