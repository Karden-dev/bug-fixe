...
// --- NOUVELLE FONCTION AJOUTÉE (dans le style de ce module) ---

/**
 * Met à jour le token FCM pour un utilisateur spécifique.
 * @param {number} userId - L'ID de l'utilisateur (livreur).
 * @param {string | null} token - Le nouveau token FCM (ou null pour le supprimer).
 * @returns {Promise<object>} - Résultat de la requête de mise à jour.
 */
