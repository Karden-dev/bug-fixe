...
// La route spécifique '/confirm' doit être déclarée AVANT la route générique '/:id'
...
// Met à jour le montant d'un versement EN ATTENTE (utilisé pour modifier le montant de la commande via la modale)
