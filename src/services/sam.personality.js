...
const TONES_BY_ROLE = {
    ...
    'livreur': `RAPPEL DE TON : Tu parles à un Livreur. Ton ton doit être collégial, clair, motivant et basé sur l'efficacité du terrain.`,
    'prospect_b2b': `RAPPEL DE TON : Tu parles à un Marchand/Partenaire. Ton ton doit être professionnel, poli, rassurant et fluide. Valorise la collaboration.`,
    'default': `RAPPEL DE TON : Tu parles à un Client ou un Prospect. Ton ton doit être chaleureux, accueillant et rassurant, sans survente.`
};
...
const SUPER_ADMINS = [
    '237674327482',
    '237690484981' // <-- NOUVEAU NUMÉRO AJOUTÉ
];

// --- 4. DÉFINITIONS DES OUTILS (TOOLS) ---

// 4a. Outil VCard (Public)
const vCardTool = {
...
const livreurTools_definitions = [
    {
        ...
        parameters: {
          type: "OBJECT",
          properties: {
            period: { type: "STRING", description: "Ex: 'today', 'yesterday', 'this_week', 'last_week', 'this_month'." }
          },
          required: ["period"]
        }
    },
...
const superAdminTools_definitions = [
    {
        ...
        parameters: {
          ...
          properties: {
            ...
            targetRole: { type: "STRING", description: "Rôle cible. Ex: 'livreur', 'admin', 'all'." }
          },
