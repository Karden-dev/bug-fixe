...
--
-- Hôte : localhost:3306
-- Généré le : sam. 15 nov. 2025 à 01:22
...
--
-- Structure de la table `customer_conversation_state`
--

CREATE TABLE `customer_conversation_state` (
  `customer_phone` varchar(30) NOT NULL COMMENT 'Numéro de téléphone du client (ex: 237...)',
  `pending_feedback_order_id` int(11) NOT NULL COMMENT 'ID de la commande en attente d''avis',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Index pour la table `customer_conversation_state`
--
ALTER TABLE `customer_conversation_state`
  ADD PRIMARY KEY (`customer_phone`),
  ADD KEY `idx_order_id` (`pending_feedback_order_id`);
...
--
-- Contraintes pour la table `customer_conversation_state`
--
ALTER TABLE `customer_conversation_state`
  ADD CONSTRAINT `fk_pending_order` FOREIGN KEY (`pending_feedback_order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE;
